    ...
    <section className="sm:mt-[40px] xr:mt-[20px] mt-[40px] sm:mb-[70px] xr:mb-[30px] mb-[100px]">
      <div className="container">
        <div className="py-[24px]">
          ...
          {cards.map((card,i)=>(
            <div key={i} className="rounded-[20px] xs:relative bg-white max-w-[392px] w-full sm:px-5 sm:py-5 xr:px-2 xr:py-2 px-5 py-5 sm:mx-3 xr:mx-0 mx-3 sm:my-3 sx:mb-3 sm:mb-4 mb-0">
